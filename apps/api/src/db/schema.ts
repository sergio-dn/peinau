...
export const invoices = pgTable('invoices', {
  ...
  montoExento: bigint('monto_exento', { mode: 'bigint' }).default(BigInt(0)).notNull(),
  montoNeto: bigint('monto_neto', { mode: 'bigint' }).default(BigInt(0)).notNull(),
  montoIva: bigint('monto_iva', { mode: 'bigint' }).default(BigInt(0)).notNull(),
  tasaIva: numeric('tasa_iva', { precision: 5, scale: 2 }).default('19').notNull(),
  montoTotal: bigint('monto_total', { mode: 'bigint' }).notNull(),
...
export const invoiceLines = pgTable('invoice_lines', {
  ...
  precioUnitario: bigint('precio_unitario', { mode: 'bigint' }),
  descuentoPct: numeric('descuento_pct', { precision: 5, scale: 2 }).default('0').notNull(),
  montoItem: bigint('monto_item', { mode: 'bigint' }).notNull(),
...
export const approvalWorkflowLevels = pgTable('approval_workflow_levels', {
  ...
  name: varchar('name', { length: 255 }).notNull(),
  minAmount: bigint('min_amount', { mode: 'bigint' }).default(BigInt(0)).notNull(),
...
export const paymentBatches = pgTable('payment_batches', {
  ...
  totalAmount: bigint('total_amount', { mode: 'bigint' }).default(BigInt(0)).notNull(),
...
export const paymentBatchItems = pgTable('payment_batch_items', {
  ...
  retencionHonorarios: bigint('retencion_honorarios', { mode: 'bigint' }).default(BigInt(0)).notNull(),
  amountNet: bigint('amount_net', { mode: 'bigint' }).notNull(),
}, (table) => ({
